...
<div class="container">
    ...
    <div class="row mt-3">
        <div class="col">
            <form action="index.php?controller=post&action=store" class="" method="POST">
                <?php if ($error !== null) : ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" id="date_publicate" name="date_publicate">
                </div>
                <div class="mb-3">
                    <label for="time_publicate" class="form-label">Время публикации</label>
                    <input type="time" id="time_publicate" name="time_publicate">
                </div>
